...
{
    public class LocalEncounterImagesJsonRetriever : IEncounterImagesJsonRetriever
    {
        protected IServerStringReader ServerReader { get; }
        protected IUrlBuilder UrlBuilder { get; }
        public LocalEncounterImagesJsonRetriever(IServerStringReader serverReader, IUrlBuilder urlBuilder)
        {
